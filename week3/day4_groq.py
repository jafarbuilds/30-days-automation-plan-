...
with open("week1/recipients.csv", newline="") as file:
    ...
    for row in reader:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "You are a professional customer support agent. Write brief, polite emails."},
                {"role": "user", "content": f"Write a welcome email for a new customer named {name}."}
            ]
        )
